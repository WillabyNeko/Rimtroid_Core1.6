...
namespace RT_Core
{
    public class Hediff_LatchedMetroid : HediffWithComps
    {
        ...
        public override void PostAdd(DamageInfo? dinfo)
        {
            ...
            HealthUtility.AdjustSeverity(this.pawn, RT_DefOf.RT_LifeDrainSickness, (this.drainSicknessSeverity / (float)drainOverlayDuration) * 30f);
        ...
        public override void Tick()
        {
            ...
            if (Find.TickManager.TicksGame % 30 == 0)
            {
                ...
                HealthUtility.AdjustSeverity(this.pawn, RT_DefOf.RT_LifeDrainSickness, value * this.pawn.BodySize);
            }
        }
